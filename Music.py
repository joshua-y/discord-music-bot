...
class VoiceState:
    ...
    async def audio_player_task(self):
        while True:
            ...
            embed=discord.Embed(title="Now Playing", color=0x003366)
            embed.add_field(name=str(self.current), value="\u200b", inline=False)
...
class Music:
    ...
    async def p(self, ctx, *, song : str):
        ...
        try:
            ...
            embed=discord.Embed(title="Queued", color=0x003366)
    ...
    #async def on_voice_state_update(self, before, after):
        #tate = self.get_voice_state(server)
